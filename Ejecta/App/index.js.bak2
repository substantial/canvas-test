...
var maxCurves = 70;
var increaseCurves = function (ev) {
...
document.addEventListener( 'touchmove', increaseCurves, false );
document.addEventListener( 'mousemove', function() { shoot.play()}, false );
